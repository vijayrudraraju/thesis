...
\emph{Mapping} is a concept that is useful in a number of disciplines. Within the discipline of designing digital musical instruments, mapping refers to the relationship between sensor outputs and sound synthesis algorithm inputs in a DMI. It has been shown that the choice of mapping is a primary factor in the design of DMIs \cite{hunt2003}. Designers must have a clear sense of the space of possible configurations for a given set of control sensors and sound synthesizers, if they are to devise mapping strategies that effectively translate their design intentions into a functioning system. 
